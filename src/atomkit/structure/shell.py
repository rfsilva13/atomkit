...
# Import from parent atomkit package
from ..constants import \
    validate_j_quantum  # Import the new validation function
from ..constants import (ANGULAR_MOMENTUM_MAP, L_QUANTUM_MAP,
...
class Shell:
    ...
    def __str__(self) -> str:
        ...
        For zero occupation, returns notation like '1s0' to represent empty shells (holes).
        """
    ...
    @classmethod
    def from_string(cls, shell_string: str):
        """
        ...
        Returns:
            A Shell object instance, or a list of Shells if ambiguous j (l>0, no j specified).
        ...
        # If no j symbol is provided we treat the shell as non-relativistic
        # (single subshell with j_quantum=None). This ensures Configuration
        # objects are non-relativistic by default and avoids splitting the
        # occupation across j-sublevels automatically. If the user explicitly
        # specifies '+' or '-' the corresponding j_quantum will be used.
