"""
AtomKit → FAC: Automated Configuration Generation
==================================================
...
# Step 6: Validate (catches errors before calculation!)
for cfg in all_configs:
    cfg.validate()
print("✅ All configurations validated!")

# Step 7: Create FAC calculation with Breit autocalc = AtomicCalculation(
    element="Fe",
    charge=16,
